...
public class EstatisticasController {
    ...
    public ResponseEntity<byte[]> consultarVendasPdf(VendaDiariaFilter filtro,
        ...
        headers.add(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=vendas-diarias.pdf"); //attachment -> conteudo que estamos retornando na resposta da requisitcao é para ser baixado pelo cliente
