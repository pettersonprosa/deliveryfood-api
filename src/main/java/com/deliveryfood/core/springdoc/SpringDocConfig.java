...
import com.deliveryfood.api.exceptionhandler.Problem;
...
public class SpringDocConfig {
    ...
    // SpringDocConfig(LocalValidatorFactoryBean validator) {
        ...
        return new OpenAPI()
            .info(new Info()
                ...
                .license(new License()
                    ...
                    .url("https://www.google.com/search?q=delivery+food")
                ).tags(Arrays.asList(
